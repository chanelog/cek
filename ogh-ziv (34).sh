...
draw_logo() {
    ...
    echo -e "  ${A1}╠══════════════════════════════════════════════════════════╣${NC}"
    echo -e "  ${A1}║            ${A4}*  SECURE VPN MANAGEMENT SYSTEM  *${NC}            ${A1}║${NC}"
    echo -e "  ${A1}║               ${DIM}+------ ${A2}[ PREMIUM ]${DIM} -------+${NC}               ${A1}║${NC}"
    echo -e "  ${A1}╚══════════════════════════════════════════════════════════╝${NC}"
}
...
main_menu() {
    ...
    while true; do
        ...
        # ── Judul ────────────────────────────────────────────
        echo -e "  ${A1}╔══════════════════════════════════════════════════════════╗${NC}"
        echo -e "  ${A1}║     ${A1}+----------  ${BLD}${AL}OGH-ZIV PREMIUM PANEL${NC}  ${A1}----------+${NC}      ${A1}║${NC}"
        echo -e "  ${A1}╚══════════════════════════════════════════════════════════╝${NC}"
        echo ""
        ...
        _sep2
        _row2s "${A4}" "[0]  x  Keluar"  14  "${DIM}" "OGH-ZIV v1.0"  13
        _bot2
